<template>
  <div class="Login">
    <div class="header">
      <div class="login_bg">
        <div class="head-top">
          <a href="#" class="aback" onclick="history.go(-1)"></a>
          <div class="zfont ">
            <a href="#" class="afff" @click="RegShow">注册</a>
          </div>
        </div>
        <div class="logo">
          <img src="../../common/img/logo1.png" alt="">
        </div>
        <div class="title">
          <ul class="login">
            <li class="selectTag4">
              <a href="#" @click="toggleShow(true)">普通登录</a>
              <i v-if="isShow"></i>
            </li>
            <li class="selectTag4" @click="ShowNow1">
              <a href="#" @click="toggleShow(false)" >手机动态密码登录</a>
            ...
            <div class="Content4">
              ...
              <div class="other_login">
                ...
                <ul class="uList1">
                  <li >
                    <a href="#">
                      <img src="../../common/img/ic3.png" alt="">
                    </a>
                  </li>
                  <li >
                    <a href="#">
                      <img src="../../common/img/ic4.png" alt="">
                    </a>
                  </li>
                </ul>
              </div>
            ...
            <div class="Content4">
              <ul class="mform">
                ...
                <li>
                  ...
                  <a href="#" class="getMsg" @click="sendCode" >
                    获取动态密码
                  </a>
                </li>
              </ul>
        ...
        <form action="#" id="regaddform">
          <ul class="Reg_user">
            ...
            <li>
              ...
              <a href="#" v-show="show" class="msg" @click="sendCode" >
  ...
  .header
    ...
    .login_bg
      ...
      .head-top
        ...
        padding 0 1em
        .aback
          background url(../../common/img/left.png) no-repeat
          ...
          .mform
            li
              ...
              .mNumIco
                float left
                display inline
                background url(../../common/img/ico4.png)
              ...
              .mNameIco
                float left
                display inline
                background url(../../common/img/ic1.png)
                background-size contain
                width 17px
                height 21px
                margin 1px 0 0 -25px
              ...
              .mpasswordIco
                ...
                height 20px;
                margin 0px 0 0 -25px;
                background url(../../common/img/ic2.png) no-repeat
                background-size contain
              .verification1
